                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($rol === 'agente'): ?>
                                                                    <a href="<?php echo base_url('asignar_ticket/' . $ticket['id'] . '/atender'); ?>" class="btn btn-sm btn-success">Atender</a>
                                                                <?php elseif ($rol === 'supervisor' || $rol === 'administrador'): ?>
                                                                    <form method="post" action="<?php echo base_url('asignar_ticket/' . $ticket['id']); ?>" style="display:inline;">
                                                                        <select name="agente_id" class="form-control form-control-sm d-inline-block" style="width: 150px;">
